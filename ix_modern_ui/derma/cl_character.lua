...
function PANEL:Paint(width, height)
	...
	local matrix
		...
		if ScrW() < 1900 then
draw.DrawText([[Your screen resolution is not supported. Please report any bugs.
If you can, please use 1920x1080 (native) resolution ]], "ixMenuMiniFont", 5, height - 40, Color(226, 62, 40), TEXT_ALIGN_LEFT)
		end
...
function PANEL:Init()
	...
	--self.loadButton:SetFont("DermaLarge")
	self.loadButton:SetContentAlignment(5)
	self.loadButton:SetSize(50, 65)
	self.loadButton.DoClick = function()
		self:Dim()
		parent.loadCharacterPanel:SlideUp()
		
		local character = ix.char.loaded[ix.characters[1]]
		parent.loadCharacterPanel.carousel:SetActiveCharacter(character)
		parent.loadCharacterPanel.character = character
		parent.loadCharacterPanel.characterid = 1
	end
...
--
	...
	--self.returnButton:SetFont("DermaLarge")
	...
	self.returnButton:SetSize(50, 65)
...
function PANEL:PerformLayout(width, height)
	...
	self.mainButtonList:SetPos(width * 0.5 - 240, height - self.mainButtonList:GetTall() - 400)
end
