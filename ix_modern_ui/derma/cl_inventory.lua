...
function PANEL:Init()
	...
	--self.Title:SetFont("ixMenuButtonFontThick")
	--self.Title:SetTall(28)
	--self.Title:SetSize(self:GetWide() * 7,50)
	--self.Title:SetPos(0,0)
    --self.Title:SetContentAlignment(5)
	--self.Title:SetTextColor(color_white)
	--self.Title:SetExpensiveShadow(1, Color(0, 21, 214, 150))
	--self.Title:SetText("Ekwipunek")
	...
	for x = 1, self.gridW do
		...
		for y = 1, self.gridH do
			...
			slot.Paint = function(panel, width, height)
				...
				surface.DrawOutlinedRect( 1,1, width - 2, height - 2, 1 )
