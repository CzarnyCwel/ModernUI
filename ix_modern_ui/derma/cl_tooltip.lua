...
function PANEL:SizeToContents()
	...
	if (contentWidth > self.maxWidth) then
		...
		if contentWidth < 210 then
			self:SetSize(contentWidth + 50, contentHeight)
		else
			self:SetSize(contentWidth + 10, contentHeight)
		end
	end
end
...
function PANEL:PaintBackground(width, height)
	if (self.backgroundColor) then
		...
		surface.SetDrawColor(ColorAlpha(self.backgroundColor, 10 ))
